...
* Handled different types of VOD such as: multi audio where the audio and subtitle track was disconnected from the video and the user could change any audio/subtitle track without reloading the media; single audio where the audio and subtitles were inserted directly into the media, to change the audio or subtitles it was necessary to load a new media with a predefined configuration, it was not possible to choose just the audio or just the subtitles, the user was forced to change both tracks together; DVB where the subtitle was received in base64 and it was necessary to display it as an image over the content;
